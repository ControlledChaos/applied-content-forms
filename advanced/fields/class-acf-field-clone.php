...
class acf_field_clone extends acf_field {
	...
	*/
	...
	function initialize() {
		...
		// AJAX query.
		add_action( 'wp_ajax_acf/fields/clone/query', [ $this, 'ajax_query' ] );

		// Filters.
		add_filter( 'acf/get_fields', [ $this, 'acf_get_fields' ], 5, 2 );
		add_filter( 'acf/prepare_field', [ $this, 'acf_prepare_field' ], 10, 1 );
		add_filter( 'acf/clone_field', [ $this, 'acf_clone_field' ], 10, 2 );
	}
