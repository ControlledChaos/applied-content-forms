										...
										<div id="minor-publishing">
											...
											<div id="misc-publishing-actions">
												...
												<div class="misc-pub-section acfe-misc-export">
													...
													Export:
													<a href="<?php echo admin_url("admin.php?page=acf-tools&tool=acfe_settings_export&action=php"); ?>">PHP</a>
													<a href="<?php echo admin_url("admin.php?page=acf-tools&tool=acfe_settings_export&action=json"); ?>">Json</a>
												</div>
											</div>
