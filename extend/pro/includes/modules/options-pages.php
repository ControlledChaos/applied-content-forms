...
if(!class_exists('acfe_pro_dynamic_options_pages')):
...
class acfe_pro_dynamic_options_pages{
    ...
    function __construct(){
        ...
        add_action('acfe/options_page/save',            array($this, 'save'), 15, 3);
        add_action('acfe/options_page/import_fields',   array($this, 'import_fields'), 15, 3);
    ...
    function add_local_field_group(){
        ...
        acf_add_local_field_group(array(
            'key' => 'group_acfe_dynamic_options_page_side',
...
acf_new_instance('acfe_pro_dynamic_options_pages');
