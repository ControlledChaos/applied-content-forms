...
class ACFE_Field_Group{
    ...
    function submitbox( $post ) {
        ...
        $export_php = admin_url( 'admin.php?page=acf-tools&tool=export&action=php&keys=' . $field_group['key'] );
        $export_json = admin_url( 'admin.php?page=acf-tools&tool=export&action=json&keys=' . $field_group['key'] );
