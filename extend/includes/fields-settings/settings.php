...
class acfe_field_settings{
    ...
    function load_field($field){
        ...
        foreach($field['ACF_Module_Settings'] as $k => $rule){
            ...
            // Screen: Admin
            elseif($screen === 'admin' && acf_is_admin()){
            ...
            // Screen: Front
            elseif($screen === 'front' && acf_is_front()){
    ...
    function load_field_additional($field){
        ...
        if($hide_required){
            ...
            if(is_bool($hide_required) || $hide_required === 'all' || ($hide_required === 'front' && acf_is_front()) || $hide_required === 'admin' && acf_is_admin()){
    ...
    function prepare_field($field){
        ...
        if($hide_field){
            ...
            if(is_bool($hide_field) || $hide_field === 'all' || ($hide_field === 'front' && acf_is_front()) || $hide_field === 'admin' && acf_is_admin()){
        ...
        if($hide_label){
            ...
            if(is_bool($hide_label) || $hide_label === 'all' || ($hide_label === 'front' && acf_is_front()) || $hide_label === 'admin' && acf_is_admin()){
        ...
        if(is_bool($hide_instructions) || $hide_instructions === 'all' || ($hide_instructions === 'front' && acf_is_front()) || $hide_instructions === 'admin' && acf_is_admin()){
...
acf_new_instance( 'acfe_field_settings' );
