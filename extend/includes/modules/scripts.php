...
class acfe_pro_scripts{
    ...
    function __construct(){
        ...
        // scripts
        acf_include('extend/includes/modules/scripts/script-orphan-meta-cleaner.php');
        acf_include('extend/includes/modules/scripts/script-single-meta-converter.php');

        // scripts demo
        if(acfe_get_setting('modules/scripts/demo')){

            acf_include('extend/includes/modules/scripts/script-count-posts.php');
            acf_include('extend/includes/modules/scripts/script-export-posts.php');
            acf_include('extend/includes/modules/scripts/script-import-posts.php');
