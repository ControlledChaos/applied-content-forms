...
class acfe_compatibility{
    ...
    function update_settings() {
        ...
        if(acf_get_setting('acfe/modules/dynamic_templates') !== null){
            acf_update_setting('modules/templates', acf_get_setting('acfe/modules/dynamic_templates'));
        }
     ...
     * The plugin add a submenu to 'Custom Fields' to order Field Group Categories. It's unnecessary
     */
