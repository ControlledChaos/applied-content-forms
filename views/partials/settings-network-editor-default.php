...
?>
<h2 id="tinymce-editor-options"><?php _e( 'Editor Settings', 'acf' ); ?></h2>

<table class="form-table">
	<?php wp_nonce_field( 'allow-site-admin-settings', 'tinymce-editor-network-settings' ); ?>
	<tr>
		<th scope="row"><?php _e( 'Default editor for all sites', 'acf' ); ?></th>
		<td>
			<p>
	...
	<tr>
		<th scope="row"><?php _e( 'Change settings', 'acf' ); ?></th>
		<td>
			...
			<label for="tinymce-editor-allow-sites"><?php _e( 'Allow site admins to change settings', 'acf' ); ?></label>
			<p class="description"><?php _e( 'By default the block editor is replaced with the rich text editor and users cannot switch editors.', 'acf' ); ?></p>
		</td>
	</tr>
</table>
