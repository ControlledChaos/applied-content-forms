...
**Applied:** put to something practical use, especially to solve definite problems.
...
Applied Content Forms is a plugin for ClassicPress and WordPress that provides a suite of tools for adding & managing custom content types and user forms.
