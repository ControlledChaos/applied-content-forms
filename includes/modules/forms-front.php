...
class acfe_form_front{
    ...
    function validate_form($param){
        ...
        // advanced override
        $args['form_attributes']['class'] = 'acf-form ' . $args['form_attributes']['class'];
    ...
    function form_success($args){
        ...
        $atts = acf_esc_attrs(array(
            'class'          => 'acf-form-success',
            'data-form-name' => $args['name'],
            'data-form-id'   => $args['ID'],
        ));

        // <div class="acf-form-success"></div>
        echo "<div {$atts}></div>";
    ...
    function get_form($param){
        ...
        if(is_numeric($param)){
            ...
            // check post type
            if(get_post_type($param) !== 'acf-form'){
                return false;
            }
        ...
        elseif(is_string($param)){
            ...
            if(!$form = get_page_by_path($param, OBJECT, 'acf-form')){
                return false;
            }
