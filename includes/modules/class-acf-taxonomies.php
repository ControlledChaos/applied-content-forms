		...
		acf_add_local_field_group(array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'text',
					'instructions' => 'Which template file to load for the term query. More informations on <a href="https://developer.wordpress.org/themes/basics/template-hierarchy/">Template hierarchy</a>',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					...
					'type' => 'number',
					'instructions' => 'Number of posts to display on the admin list screen',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					...
					'type' => 'text',
					'instructions' => 'Sort retrieved posts by parameter in the admin list screen. Defaults to \'date (post_date)\'.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					...
					'type' => 'select',
					'instructions' => 'Designates the ascending or descending order of the \'orderby\' parameter in the admin list screen. Defaults to \'DESC\'.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					...
					'type' => 'number',
					'instructions' => 'Number of terms to display on the admin list screen',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					...
					'type' => 'text',
					'instructions' => 'Sort retrieved terms by parameter in the admin list screen. Accepts term fields \'name\', \'slug\', \'term_group\', \'term_id\', \'id\', \'description\', \'parent\', \'count\' (for term taxonomy count), or \'none\' to omit the ORDER BY clause',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
				...
				array(
					...
					'type' => 'select',
					'instructions' => 'Designates the ascending or descending order of the \'orderby\' parameter in the admin list screen. Defaults to \'ASC\'.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array(
						'width' => '',
