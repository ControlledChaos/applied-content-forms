...
class acfe_script_single_meta_converter extends acfe_script{
    ...
    function validate(){
        ...
        if($conversion === 'normal_to_single' && !$single_meta){
            ...
            return acf_add_validation_error('conversion', 'Single Meta module must be enabled to use this conversion');
        ...
        if($conversion === 'single_to_normal' && $single_meta){
            ...
            return acf_add_validation_error('conversion', 'Single Meta module must be disabled to use this conversion');
        ...
        if(empty($post_types) && empty($taxonomies) && empty($users) && empty($options_pages)){
            ...
            // Add global error
            return acf_add_validation_error('', 'Select at least one object type to convert: Post Type, Taxonomy, User or Options Page');
