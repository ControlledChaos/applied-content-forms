...
class acfe_pro_scripts{
    ...
    function __construct(){
        ...
        // scripts
        acf_include('includes/modules/scripts/class-acf-script-orphan-meta-cleaner.php');
        acf_include('includes/modules/scripts/class-acf-script-single-meta-converter.php');

        // scripts demo
        if(acf_get_setting('acfe/modules/scripts/demo')){

            acf_include('includes/modules/scripts/class-acf-script-count-posts.php');
            acf_include('includes/modules/scripts/class-acf-script-export-posts.php');
            acf_include('includes/modules/scripts/class-acf-script-import-posts.php');
    ...
    function load(){
        ...
        if($this->is_post()){
            ...
            if(acf_verify_nonce('acfe_scripts') && isset($_POST['save'])){
                ...
                // Update Settings
                acf_update_module_settings("modules.scripts.{$this->script->name}", $acf);
    ...
    function postbox_acf($post, $metabox){
        ...
        $meta = acf_get_module_settings("modules.scripts.{$this->script->name}", array());
