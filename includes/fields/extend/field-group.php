...
class acfe_field_group_field{
    ...
    function render_field_settings($field){
        ...
        acf_render_field_setting($field, array(
            ...
            'instructions'  => __('Edit fields in a modal window'),
            'type'              => 'true_false',
            'message'           => '',
            'default_value'     => false,
            'ui'                => true,
        ...
        acf_render_field_setting($field, array(
            'label'         => __('Modal Button Text'),
            'name'          => 'acfe_group_modal_button',
            'key'           => 'acfe_group_modal_button',
            'instructions'  => __('Text displayed in the modal button'),
            'type'          => 'text',
        ...
        acf_render_field_setting($field, array(
            ...
            'instructions'  => __('Choose the modal window size'),
            'type'          => 'select',
            'choices'       => array(
                'small'     => 'Small',
                'medium'    => 'Medium',
