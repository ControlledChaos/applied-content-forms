...
class ACF_Admin_Field_Groups {
	 ...
	 *
	 * Returns the Field Groups admin URL taking
	 * into account the current view.
	 *
	 * @since  1.0.0
	 * @access public
	 * @param  string $params Extra URL params.
	...
	public function current_screen() {
		...
		// Stop if not Field Groups admin page.
		...
		add_filter( 'views_edit-acf-field-group', [ $this, 'admin_table_views' ], 10, 1 );
		add_filter( 'manage_acf-field-group_posts_columns', [ $this, 'admin_table_columns' ], 10, 1 );
		add_action( 'manage_acf-field-group_posts_custom_column', [ $this, 'admin_table_columns_html' ], 10, 2 );
		add_filter( 'display_post_states', [ $this, 'display_post_states' ], 10, 2 );
		add_filter( 'bulk_actions-edit-acf-field-group', [ $this, 'admin_table_bulk_actions' ], 10, 1 );
		...
		if ( 'sync' === $this->view ) {
			add_action( 'admin_footer', [ $this, 'admin_footer__sync' ], 1 );
		}
	}
	...
	/**
	 * Render admin table column locations
	 *
	 * @since  1.0.0
	 * @access public
	 * @param  array $field_group The field group.
	...
	public function check_duplicate() {
		...
		} elseif ( isset( $_GET['post'], $_GET['action2'] ) && 'acfduplicate' === $_GET['action2'] ) {
	...
	public function check_sync() {
		...
		} elseif ( isset($_GET['post'], $_GET['action2']) && 'acfsync' === $_GET['action2'] ) {
