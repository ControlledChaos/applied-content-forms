<div class="wrap" id="acfe-admin-options">
    ...
    <h1 class="wp-heading-inline"><?php _e('Options Editor'); ?></h1>
    <a href="<?php echo sprintf('?page=%s&action=add', esc_attr($_REQUEST['page'])); ?>" class="page-title-action"><?php _e('Add Option'); ?></a>
